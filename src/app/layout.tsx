...
export const metadata: Metadata = {
  title: "CompClub - Computer Club Community",  description: "Join our thriving computer club. Connect with tech enthusiasts, learn coding, collaborate on projects, and build your career in technology.",  keywords: "computer club, coding, technology, programming, hackathon, tech community",  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
