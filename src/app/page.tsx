    ...
    >
      ...
      <div id="team" data-section="team">
        <TeamCardTwo
          ...
          members={[
            {
              id: "1",              name: "Alex Chen",              role: "Club President",              description: "Full-stack developer passionate about mentoring. Leads strategic initiatives and oversees all club operations.",              imageSrc: "/api/placeholder/400/400",              imageAlt: "Alex Chen, Club President",              socialLinks: [
                { icon: Github, url: "https://github.com" },
                { icon: Linkedin, url: "https://linkedin.com" }
              ]
            },
            {
              id: "2",              name: "Maya Patel",              role: "Vice President",              description: "Data science enthusiast focused on community engagement. Organizes workshops and social events.",              imageSrc: "/api/placeholder/400/400",              imageAlt: "Maya Patel, Vice President",              socialLinks: [
                { icon: Github, url: "https://github.com" },
                { icon: Twitter, url: "https://twitter.com" }
              ]
            },
            {
              id: "3",              name: "Jordan Lee",              role: "Event Coordinator",              description: "Creative problem-solver organizing hackathons and competitions. Ensures memorable experiences for all members.",              imageSrc: "/api/placeholder/400/400",              imageAlt: "Jordan Lee, Event Coordinator",              socialLinks: [
                { icon: Linkedin, url: "https://linkedin.com" },
                { icon: Globe, url: "https://example.com" }
              ]
            },
            {
              id: "4",              name: "Sam Torres",              role: "Tech Lead",              description: "Backend expert driving our technical infrastructure. Mentors developers and manages projects.",              imageSrc: "/api/placeholder/400/400",              imageAlt: "Sam Torres, Tech Lead",              socialLinks: [
                { icon: Github, url: "https://github.com" },
                { icon: Linkedin, url: "https://linkedin.com" }
              ]
            }
      ...
      <div id="testimonials" data-section="testimonials">
        <TestimonialCardSix
          ...
          testimonials={[
            {
              id: "1",              name: "Sarah Johnson",              handle: "@sarah_codes",              testimonial: "Joining the computer club transformed my coding skills. The mentorship and collaborative projects gave me real-world experience I couldn't get elsewhere.",              imageSrc: "/api/placeholder/200/200",              imageAlt: "Sarah Johnson"
            },
            {
              id: "2",              name: "Michael Rodriguez",              handle: "@mrodriguez_dev",              testimonial: "The hackathons organized by this club are incredible. I've built my portfolio, made lasting friendships, and gained confidence in my abilities.",              imageSrc: "/api/placeholder/200/200",              imageAlt: "Michael Rodriguez"
            },
            {
              id: "3",              name: "Emily Wang",              handle: "@emily_codes",              testimonial: "As someone new to programming, the welcoming community and diverse skill levels made it easy to learn. The workshops are top-notch!",              imageSrc: "/api/placeholder/200/200",              imageAlt: "Emily Wang"
            },
            {
              id: "4",              name: "David Kim",              handle: "@davidkim_tech",              testimonial: "The networking opportunities at club events led to internship offers. This community opens doors and builds connections that last.",              imageSrc: "/api/placeholder/200/200",              imageAlt: "David Kim"
            },
            {
              id: "5",              name: "Jessica Lopez",              handle: "@jess_develops",              testimonial: "Best decision I made was joining CompClub. The supportive environment and quality projects have accelerated my career growth significantly.",              imageSrc: "/api/placeholder/200/200",              imageAlt: "Jessica Lopez"
            },
            {
              id: "6",              name: "Alex Thompson",              handle: "@alexthompson99",              testimonial: "Outstanding club with passionate members and leaders. We celebrate wins together, learn from failures, and always push each other to be better.",              imageSrc: "/api/placeholder/200/200",              imageAlt: "Alex Thompson"
            }
          ]}
          speed={40}
        />
